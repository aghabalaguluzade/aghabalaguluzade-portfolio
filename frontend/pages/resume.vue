                    ...
                    <div data-aos="fade" class="aos-init aos-animate">
                        <div class="container sm:px-5 md:px-10 lg:px-20">
                            <div class="py-12 px-4">
                                <h2 class="after-effect after:left-44 mb-[40px] mt-12 lg:mt-0"> Xülasə </h2>
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-6">
                                    ...
                                    <div>
                                        <div class="flex items-center space-x-2 mb-4">
                                            ...
                                            <h4 class="text-5xl dark:text-white font-medium"> Təhsil </h4>
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center space-x-2 mb-4">
                                            ...
                                            <h4 class="text-5xl dark:text-white font-medium"> Təcrübə </h4>
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center space-x-2 mb-4">
                                            ...
                                            <h4 class="text-5xl dark:text-white font-medium"> Mükafatlar </h4>
                                        </div>
                        ...
                        <div class="container bg-[#f8fbfb] dark:bg-[#0D0D0D] py-12 px-4 sm:px-5 md:px-10 lg:px-20">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div class="col-span-1">
                                    <h4 class="text-5xl dark:text-white font-medium mb-6"> İş Bacarıqları </h4>
                                    <div class="mb-5">
                                ...
                                <!-- button group -->
                                <div class="col-span-1">
                                    <h4 class="text-5xl dark:text-white font-medium mb-8"> Biliklər </h4>
...
<script setup>
    import AppFooter from '~/components/AppFooter.vue';
     ...
     const title = ref('Aghabala Guluzade | Xülasə');
</script>