<template>
     <Head>
          ...
          <div class="container mb-8 px-4 sm:px-5 md:px-10 lg:px-[60px]">
            ...
            <div id="isotop-gallery-wrapper" class="mymix portfolio_list-two  three-col " style="position: relative; height: 1545.75px;">
              ...
              <div class="portfolio_list-two-items isotop-item plugin " style="position: absolute; left: 0%; top: 278px;">
                <div class="rounded-lg bg-[#fff3fc] dark:bg-transparent p-6 dark:border-[2px] border-[#212425]">
                  <div class="overflow-hidden rounded-lg">
              ...
              <div class="portfolio_list-two-items isotop-item dev custom " style="position: absolute; left: 50%; top: 355px;">
              ...
              <div class="portfolio_list-two-items isotop-item branding " style="position: absolute; left: 0%; top: 595px;">
                <div class="rounded-lg bg-[#fffae9] dark:bg-transparent p-6 dark:border-[2px] border-[#212425]">
                  ...
                  <span class="pt-5 text-[14px] font-normal text-gray-lite block dark:text-[#A6A6A6]">Web Design</span>
                  <h2 class="font-medium cursor-pointer text-xl duration-300 transition hover:text-[#FA5252] dark:hover:text-[#FA5252] dark:text-white mt-2">
              ...
              <div class="portfolio_list-two-items isotop-item branding " style="position: absolute; left: 50%; top: 710px;">
              ...
              <div class="portfolio_list-two-items isotop-item plugin " style="position: absolute; left: 0%; top: 912px;">
                <div class="rounded-lg bg-[#f4f4ff] dark:bg-transparent p-6 dark:border-[2px] border-[#212425]">
                  <div class="overflow-hidden rounded-lg">
              ...
              <div class="portfolio_list-two-items isotop-item dev branding " style="position: absolute; left: 50%; top: 1065px;">
                <div class="rounded-lg bg-[#f4f4ff] dark:bg-transparent p-6 dark:border-[2px] border-[#212425]">
                  <div class="overflow-hidden rounded-lg">
              ...
              <div class="portfolio_list-two-items isotop-item plugin custom " style="position: absolute; left: 0%; top: 1228px;">
...
<script setup>
    import AppFooter from '~/components/AppFooter.vue';
     ...
     const title = ref('Aghabala Guluzade | Portfolio');
</script>